...
String GetItemCode(UnitAny* pItem)
{
	...
	{
		ItemTxt* txt = D2COMMON_GetItemTxt(pItem->dwTxtFileNo);
		if (txt)
		{
...
ItemFlags* GetMyItemFlags(int itemnjipID)
{
	...
	if (itemnjipID	>=	307	&&	itemnjipID	<=	352 ||		//normal armor
	...
	if (itemnjipID	>=	94	&&	itemnjipID	<=	173 ||		//exc weapons
	...
	if (itemnjipID	>=	190	&&	itemnjipID	<=	196 ||		//elite katars
	...
	if (itemnjipID	>=	87	&&	itemnjipID	<=	93	||		//
		itemnjipID	==	174	||	itemnjipID	==	175 ||		//khalim's crap
